...
const ServiceCard = React.memo(
  ({ service }: { service: HairMakeupService }) => {
...
const HairMakeupDetailsPage = () => {
  ...
  const loadHairMakeupDetails = useCallback(async () => {
    if (!params.id) return;
  ...
  const handleInquirySubmit = useCallback(
    ...
    [user?.id, hairMakeup, inquiryForm, loadHairMakeupDetails]
  );
                ...
                {user ? (
                  ...
                  <div className="bg-gray-50 p-8 rounded-lg text-center">
                    <div className="max-w-md mx-auto">
                      ...
                      <p className="text-gray-600 mb-6">
                        Sign in to contact {hairMakeup.business_name} andand ask
...
export default HairMakeupDetailsPage;
