  ...
  const createListing = async () => {
    try {
      ...
      const mediaPromises = mediaFiles.map(async (file, index) => {
        ...
        const filePath = `photoVideo/${photoVideo.id}/${index}.${fileExt}`;
  ...
  const handleSubscriptionCreation = async () => {
    try {
      ...
      const response = await fetch("/api/create-subscription", {
        ...
        body: JSON.stringify({
          priceId:
            stripePriceIds["photoVideo"][selectedTier][
      ...
      toast.success(
        "Your Photo & Video listing has been created successfully!"
      );
    } catch (error) {
              ...
              <div className="max-w-4xl mx-auto px-4">
                ...
                {currentPaymentMethod && (
                  <PaymentConfirmationDialog
                    ...
                    amount={categoryPrices["photoVideo"][selectedTier].price}
