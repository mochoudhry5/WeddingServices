    ...
    switch (currentStep) {
      ...
      case 2:
        ...
        if (!hasRequiredStyles(serviceType)) {
          toast.error(
            serviceType === "both"
              ? "Please select at least one photography style and one videography style, or add custom styles"
  ...
  return (
    <ProtectedRoute>
      <NonVendorProtectedRoute>
        <CreateReachProtectedRoute tableName="photo_video_leads">
...
export default PhotoVideoInquiryForm;
